<?php
    ...
    $this->set_css($this->default_theme_path.'/bootstrap/css/elusive-icons/css/elusive-icons.min.css');
    ...
    $this->set_css($this->default_theme_path.'/bootstrap/css/main.css');
                            ...
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-default btn-outline-dark" href="<?php echo $add_url?>">
                                        <i class="el el-plus"></i> &nbsp; <span id="id_add"><?php echo $this->l('list_add'); ?></span> <?php echo $subject?>
                                    </a>
                                </div>
                            <?php } ?>
                            <div class="floatR">
