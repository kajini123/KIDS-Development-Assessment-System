...
<div class="content-wrapper">
    ...
    <img src="<?php echo base_url(); ?>assets/img/logo.png"> 
        <h1>Student Assesment Report</h1>
    ...
    <?php 
Table::create(array(
    "dataStore"=>$this->db->query("SELECT * FROM enrollment")->result_array(),
...
function CreatePDFfromHTML() {
    ...
    html2canvas($("#exContent")[0]).then(function (canvas) {
        ...
        pdf.save("Student Assesment Report.pdf");
